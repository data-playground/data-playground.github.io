...
<div id="tableauEmbed">
  ...
  {% include /tableau-embed.html url="https://public.tableau.com/views/NBA2024StatRace/UsingFilter?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link" device="tablet" height="800px" name="UsingFilter" %}

  {% include /tableau-embed.html url="https://public.tableau.com/views/NBA2024StatRace/UsingPagesandRANK?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link" device="tablet" height="800px" name="UsingPagesandRANK"  %}
